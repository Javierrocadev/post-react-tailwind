...
{
    titulo: 'Lorem ipsum',
    parrafo: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur mattis eros varius sem ornare, ut porttitor ex porta. Nam luctus massa magna, et gravida mi semper et.',
    enlace: 'https://www.ejemplo1.com'
},
{
    titulo: 'Suspendisse at',
    parrafo: 'Suspendisse at turpis eget quam convallis ornare sit amet quis urna. Donec ac sapien orci. Proin tincidunt augue fermentum magna ullamcorper blandit.',
    enlace: 'https://www.ejemplo2.com'
},
{
    titulo: 'Etiam ',
    parrafo: 'Etiam vulputate lorem nisl, non mattis ante tempor non. Cras quis tellus quis ex scelerisque rhoncus. Nam consequat, nulla at ultricies auctor, mauris quam tempor metus.',
    enlace: 'https://www.ejemplo3.com'
},
{
    titulo: 'Mauris',
    parrafo: 'Mauris ut nibh nec arcu sagittis pulvinar. Duis dignissim sem sit amet ultricies gravida. Morbi sed sagittis arcu, id facilisis massa. Maecenas ultrices pulvinar nibh.',
    enlace: 'https://www.ejemplo12.com'
},
{
    titulo: 'Enon mattis',
    parrafo: 'Enon mattis ante tempor non. Cras quis tellus quis ex scelerisque rhoncus. Nam consequat, nulla at ultricies auctor, mauris quam tempor metus.',
    enlace: 'https://www.ejemplo237.com'
},
{
    titulo: 'Cras quis',
    parrafo: 'Cras quis tellus quis ex scelerisque rhoncus. Nam consequat, nulla at ultricies auctor, mauris quam tempor metus.',
...
<div class="w-60 h-80 bg-neutral-800 rounded-3xl text-neutral-300 p-4 flex flex-col items-start justify-center gap-3 hover:bg-gray-900 hover:shadow-2xl hover:shadow-sky-400 transition-shadow">
  ...
  <a href={textos.enlace} class="bg-sky-700 font-extrabold p-2 px-6 rounded-xl hover:bg-sky-500 transition-colors">See more</a>
</div>
